    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Invalid Result Type</h1>
          <Link href="/">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-gray-900">PRP Hair Window Finder</span>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="text-center">
                    <div className="bg-blue-50 rounded-2xl p-6">
                      ...
                      <h3 className="font-semibold text-gray-900 mb-2">Free Hair Health Guide</h3>
              ...
              <Card className="p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-2">5 Alternatives to PRP</h3>
                    <p className="text-sm text-gray-600 mb-4">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-2">Hair Transplant Consultation</h3>
                    <p className="text-sm text-gray-600 mb-4">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-2">Diagnostic Session</h3>
                    <p className="text-sm text-gray-600 mb-4">
            ...
            {/* Call to Action */}
            <Card className="p-8 text-center bg-gradient-to-r from-blue-50 to-teal-50 border-blue-200">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {result.cta.title}
              </h2>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full text-sm text-gray-600">
              <CheckCircle className="w-4 h-4 text-green-500" />
